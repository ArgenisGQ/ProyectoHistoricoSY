<template>
     ...
     <app-layout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Crear</h2>
        </template>
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1">
                    ...
                    <input
                        id="precio"
                        v-model="form.url_file"
                    class="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" type="text" placeholder="FILE"
                    />
                </div>
                </div>
...
export default {
    ...
    methods:{
        submit(){
            this.$inertia.post(route('books.store'), this.form);
        }
    }
}
</script>
